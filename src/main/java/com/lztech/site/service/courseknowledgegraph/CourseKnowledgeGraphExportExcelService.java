...
@Service
public class CourseKnowledgeGraphExportExcelService {
    ...
    public void exportData(HttpServletResponse response, CourseKnowledgeGraphNodeDetailTreeModel detailTreeModel,
        ...
        try (OutputStream output = response.getOutputStream(); Workbook workbook = new XSSFWorkbook()) {
            ...
            // 2. 创建说明行
            createInstructionRow(sheet, workbook);
