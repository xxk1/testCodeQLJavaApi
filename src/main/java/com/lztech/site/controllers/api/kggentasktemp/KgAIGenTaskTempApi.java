package com.lztech.site.controllers.api.kggentasktemp;
...
public interface KgAIGenTaskTempApi {
    ...
    @ApiOperation(value = "根据课堂实录AI生成知识图谱", nickname = "knowledgeGraphAIGenByCourseVideo",
            notes = "1.云课堂老师端-课程建设知识图谱使用", tags = {"AIKnowledgeGraphGenTemp",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "successful operation"),
            @ApiResponse(code = 400, message = "参数不正确", response = ErrorResult.class),
            @ApiResponse(code = 403, message = "验证码错误", response = ErrorResult.class),
    ...
    @ApiOperation(value = "根据教材AI生成知识图谱状态查询", nickname = "knowledgeGraphAIGenByTeachingMaterialStatus",
            notes = "1.云课堂老师端-课程建设知识图谱使用", response = KgAIGenTeachingMaterialStatusResource.class, tags = {"AIKnowledgeGraphGenTemp",})
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "根据教材AI生成知识图谱节点查询",
            ...
            notes = "1.云课堂老师端-课程建设知识图谱使用", response = KgAIGenTeachingMaterialNodeResource.class, tags = {"AIKnowledgeGraphGenTemp",})
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "根据教材AI生成知识图谱子任务创建", nickname = "knowledgeGraphAIGenByTeachingMaterialNodeDetailTask", notes = "1.云课堂老师端-课程建设知识图谱使用",
            response = KgAIGenTeachingMaterialAIGenTaskBaseResource.class, tags = {"AIKnowledgeGraphGenTemp",})
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "根据教材AI生成知识图谱资源相关统计", nickname = "getKnowledgeGraphAIGenByTeachingMaterialResourceRelatedStatistics", notes = "1" +
            ".云课堂老师端-课程建设知识图谱使用", response = KgAIGenRelatedStatisticsResource.class, tags = {"AIKnowledgeGraphGenTemp",})
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "根据教材AI生成知识图谱节点详情查询", nickname = "getKnowledgeGraphAIGenByTeachingMaterialNodeDetail", notes = "1.云课堂老师端-课程建设知识图谱使用",
            response = KgAIGenTeachingMaterialNodeResourceItem.class, tags = {"AIKnowledgeGraphGenTemp",})
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "根据教材AI生成知识图谱节点关联题目查询", nickname = "getKnowledgeGraphAIGenNodeQuestion", notes = "1.云课堂老师端-课程建设知识图谱使用",
            response = KgAIGenNodeQuestionPageResource.class, tags = {"AIKnowledgeGraphGenTemp",})
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "根据教材AI生成知识图谱节点关联视频查询", nickname = "getKnowledgeGraphAIGenNodeVideo", notes = "1.云课堂老师端-课程建设知识图谱使用",
            response = KgAIGenNodeVideoPageResource.class, tags = {"AIKnowledgeGraphGenTemp",})
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "接口-根据视频id和知识点id获取智能资源列表", nickname = "getFilterAIGenNodeVideoInfoTextList",
            notes = "1.云课堂老师端-课程建设知识图谱使用", response =
            CourseKnowledgeGraphNodeVideoInfoTextModel.class, responseContainer = "List", tags = {"AIKnowledgeGraphGenTemp",})
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "根据教材AI生成知识图谱节点添加", nickname = "addKnowledgeGraphAIGenNode", notes = "1.云课堂老师端-课程建设知识图谱使用",
            tags = {"AIKnowledgeGraphGenTemp",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "成功"),
            @ApiResponse(code = 400, message = "参数不正确", response = ErrorResult.class),
            @ApiResponse(code = 403, message = "验证码错误", response = ErrorResult.class),
