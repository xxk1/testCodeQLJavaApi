...
import com.lztech.site.service.kggentask.KgAIGenTaskTempService;
...
@Controller
public class KgAIGenTaskTempApiController implements KgAIGenTaskTempApi {

    private static final Logger LOGGER = LoggerFactory.getLogger(KgAIGenTaskTempApiController.class);
    @Autowired
    private KgAIGenTaskTempService kgAIGenTaskService;
    @Autowired
    ...
    public ResponseEntity<KgAIGenTeachingMaterialStatusResource> knowledgeGraphAIGenByTeachingMaterialStatus(
        ...
        try {
            ...
            return new ResponseEntity<KgAIGenTeachingMaterialStatusResource>(kgAIGenTeachingMaterialStatusResource, HttpStatus.OK);
        } catch (Exception e) {
    ...
    public ResponseEntity<KgAIGenTeachingMaterialNodeResource> getKnowledgeGraphAIGenByTeachingMaterialNode(
        ...
        try {
            KgAIGenTeachingMaterialNodeResource kgAIGenTeachingMaterialNodeResource =
                    kgAIGenTaskService.getKgAIGenTeachingMaterialNode(courseId);
    ...
    public ResponseEntity<List<CourseKnowledgeGraphNodeVideoInfoTextModel>> getFilterAIGenNodeVideoInfoTextList(
            ...
            @NotNull @ApiParam(value = "视频信息id", required = true) @Valid @RequestParam(value = "videoInfoId", required = true) String videoInfoId,
            @NotNull @ApiParam(value = "验证码：&signKey=123123(md5加密)", required = true) @Valid @RequestParam(value = "validCode", required = true)
            String validCode) {
        ...
        try {
            List<CourseKnowledgeGraphNodeVideoInfoTextModel> resultList = kgAIGenTaskService.getFilterAIGenNodeVideoInfoTextList(nodeId, videoInfoId);
