 ...
 * 批量导入班级自定义异常返回值
 */
@ApiModel(description = "批量导入班级自定义异常返回值")
@Validated
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2023-01-05T08:14:09.524Z")
...
public class ImportClassVo   {
  ...
  public ImportClassVo successRows(Integer successRows) {
  ...
  **/
  ...
  public ImportClassVo errorRows(Integer errorRows) {
  ...
  **/
  ...
  public ImportClassVo errorInfo(List<String> errorInfo) {
    this.errorInfo = errorInfo;
    return this;
  }

  public ImportClassVo addErrorInfoItem(String errorInfoItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ImportClassVo importClassVo = (ImportClassVo) o;
    return Objects.equals(this.successRows, importClassVo.successRows) &&
        Objects.equals(this.errorRows, importClassVo.errorRows) &&
        Objects.equals(this.errorInfo, importClassVo.errorInfo);
  }
