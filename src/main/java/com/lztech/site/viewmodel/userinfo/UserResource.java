...
@Validated
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2022-06-10T12:16:34.879Z")
public class UserResource {
    ...
    @JsonProperty("teachingAge")
    private Integer teachingAge = null;

    @JsonProperty("inSchool")
    private Boolean inSchool = null;
    ...
    public UserResource position(String position) {
    ...
    public UserResource grade(String grade) {
        this.grade = grade;
        return this;
    }
    ...
    public UserResource birthDate(Date birthDate) {
    ...
    public UserResource teachingAge(Integer teachingAge) {
    ...
    public UserResource inSchool(Boolean inSchool) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.userId, userResource.userId) &&
                ...
                Objects.equals(this.position, userResource.position) &&
                Objects.equals(this.grade, userResource.grade) &&
                Objects.equals(this.birthDate, userResource.birthDate) &&
                Objects.equals(this.teachingAge, userResource.teachingAge) &&
                Objects.equals(this.inSchool, userResource.inSchool);
    }

    @Override
    public int hashCode() {
        return Objects.hash(userId, password, source, userAccountNo, userNo, userName, userType,
                userCardNo, userStatus, administrativeClassId, administrativeClassName, avatarPath,
                avatarInnerUrl, avatarOuterUrl, gender, majorId, majorName, educationType, email,
                mobile, jobTitle, collegeId, collegeName, schoolName, position, grade, birthDate, teachingAge, inSchool);
    }
    ...
    public String toString() {
        ...
        sb.append("    teachingAge: ").append(toIndentedString(teachingAge)).append("\n");
        sb.append("    inSchool: ").append(toIndentedString(inSchool)).append("\n");
        sb.append("}");
        return sb.toString();
    }
